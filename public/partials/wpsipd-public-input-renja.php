...
$judul_skpd = '';
if(!empty($input['id_skpd']) && !empty($unit)){
...
$akhir_renja = 2023;
// if(!empty($pengaturan)){
// 	$awal_renja = $pengaturan[0]['awal_renja'];
// 	$akhir_renja = $pengaturan[0]['akhir_renja'];
// }
$urut = $tahun_anggaran-$awal_renja;
...
$tahun_selesai = (!empty($tahun_anggaran)) ? $tahun_anggaran + 1 : '-';
?>
...
<h4 style="text-align: center; margin: 0; font-weight: bold;">Monitoring dan Evaluasi RENJA (Rencana Kerja) <br><?php echo $judul_skpd.'Tahun '.$tahun_anggaran.' - '.$tahun_selesai.' '.$nama_pemda; ?></h4>
...
<script type="text/javascript">
	...
	var aksi = ''
		...
		+'<label><input type="checkbox" onclick="tampilkan_edit(this);"> Edit Data RENJA</label>'
		+'<label style="margin-left: 20px;"><input type="checkbox" onclick="show_debug(this);"> Debug Cascading RENJA</label>'
