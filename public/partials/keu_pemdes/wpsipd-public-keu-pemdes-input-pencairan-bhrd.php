...
<div class="modal fade mt-4" id="modalTambahDataPencairanBHRD" tabindex="-1" role="dialog" aria-labelledby="modalTambahDataPencairanBHRDLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahDataPencairanBHRDLabel">Data Pencairan BHRD</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="tahun" onchange="get_bhrd();">
                        <?php echo $tahun ?>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="id_bhrd" />
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="submit" onclick="submitTambahDataFormPencairanBHRD(this);" class="btn btn-primary send_data">Kirim</button>
...
<script>
            ...
            detail_data(_id)
                .then(function(status) {
                    if (status) {
                        ...
                        jQuery('#modalTambahDataPencairanBHRD .send_data').attr('tipe_verifikasi', 'verikasi_admin').show();
                    }
                });
        }
            ...
            if (confirm('Apakah anda yakin untuk memverifikasi pencairan ini?')) {
                ...
                jQuery.ajax({
                    ...
                    success: function(response) {
                        jQuery('#wrap-loading').hide();
                        if (response.status == 'success') {
                            jQuery('#modalTambahDataPencairanBHRD').modal('hide');
                            get_data_pencairan_bhrd();
                        } else {
                            alert(`GAGAL! \n${response.message}`);
                        }
    ...
    function hapus_data(id) {
        ...
        if (confirmDelete) {
            ...
            jQuery.ajax({
                ...
                type: 'post',
                data: {
                    'action': 'hapus_data_pencairan_bhrd_by_id',
                    'api_key': '<?php echo get_option('_crb_api_key_extension'); ?>',
                    'id': id
                },
                dataType: 'json',
    ...
    function edit_data(_id) {
        jQuery('#wrap-loading').show();
        jQuery('#modalTambahDataPencairanBHRD .send_data').attr('tipe_verifikasi', '');
        jQuery.ajax({
            method: 'post',
            url: '<?php echo admin_url('admin-ajax.php'); ?>',
            dataType: 'json',
            data: {
                'action': 'get_data_pencairan_bhrd_by_id',
                'api_key': '<?php echo get_option('_crb_api_key_extension'); ?>',
                'id': _id,
            },
                ...
                if (res.status == 'success') {
                    ...
                    get_bhrd()
                        .then(function() {
                            ...
                            jQuery('#id_bhrd').val(res.data.id_bhrd).prop('disabled', false);
                    ...
                    if (res.status == 'success') {
                        ...
                        get_bhrd()
                            .then(function() {
                                ...
                                jQuery('#id_bhrd').val(res.data.id_bhrd).prop('disabled', true);
                                ...
                                get_pagu()
                                    .then(function() {
                                        ...
                                        jQuery('#modalTambahDataPencairanBHRD .send_data').hide();
                                        jQuery('#modalTambahDataPencairanBHRD').modal('show');
                                        resolve(true);
                                    })
                            })
    ...
    function tambah_data_pencairan_bhrd() {
        ...
        .then(function() {
            ...
            jQuery('#status_pencairan').closest('.form-group').hide().prop('disabled', false);
            jQuery('#keterangan_status_pencairan').closest('.form-group').hide().prop('disabled', false);
            jQuery('#status_pencairan').prop('checked', false);
    ...
    function submitTambahDataFormPencairanBHRD(that) {
        ...
        var id_bhrd = jQuery('#id_bhrd').val();
        if (id_bhrd == '') {
            return alert('id_bhrd tidak boleh kosong!');
        }
        ...
        if (id_data == '') {
            ...
            if (typeof rekomendasi == 'undefined') {
                return alert('Upload file Surat Rekomendasi dulu dulu!');
            }
        ...
        tempData.append('action', 'tambah_data_pencairan_bhrd');
        tempData.append('api_key', '<?php echo get_option('_crb_api_key_extension'); ?>');
        tempData.append('id_data', id_data);
        tempData.append('id_bhrd', id_bhrd);
    ...
    function get_pagu() {
        return new Promise(function(resolve, reject) {
            ...
            jQuery.ajax({
                ...
                type: "post",
                data: {
                    'action': "get_pencairan_pemdes_bhrd",
                    'api_key': jQuery("#api_key").val(),
                    'tahun_anggaran': tahun,
                    'id': id,
                },
