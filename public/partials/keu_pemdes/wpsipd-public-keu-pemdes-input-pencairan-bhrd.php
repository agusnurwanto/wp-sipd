    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button type="submit" onclick="submitTambahDataFormPencairanBHRD();" class="btn btn-primary">Kirim</button>
        ...
        success: function(res){
            if(res.status == 'success'){
                ...
                .then(function(){
                    ...
                    jQuery('#id_bhrd').val(res.data.id_bhrd);
...
function get_pagu() {
    ...
    jQuery('#id_bhrd').val(kecamatan_all[kec][desa][kegiatan][alamat][0].id);
