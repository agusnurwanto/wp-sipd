...
if (!empty($data_renstra)) {
    foreach ($data_renstra as $renstra) {
        ...
        $renstra_options .= '<option value="' . $renstra['id_jadwal_lokal'] . '">' . $tipe[$renstra['id_tipe']] . ' | ' . $renstra['nama'] . '</option>';
    }
}
...
<div class="cetak">
    <div style="padding: 10px;margin:0 0 3rem 0;">
        ...
        <h1 class="text-center" style="margin:3rem;">Jadwal Monev RENJA Lokal</h1>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    <label for="jadwal_renstra" style='display:inline-block'>Pilih Jadwal RENSTRA</label>
                    <select id="jadwal_renstra" style='display:block;width: 100%;' required>
