...
<body>
    <div id="cetak" title="APBD PERDA Lampiran VIII" style="padding: 5px; overflow: auto;">
        <table align="right" class="no-border no-padding" style="width:280px; font-size: 12px;">
            <tr>
                <td width="80" class="align-top">Lampiran VIII </td>
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th class="text_tengah atas kiri kanan bawah text_block" colspan="6">Kode</th>
                    <th class="text_tengah atas kiri kanan bawah text_block">Uraian</th>
                    <th class="text_tengah atas kiri kanan bawah text_block">RKPD (Rp)</th>
                    <th class="text_tengah atas kiri kanan bawah text_block">PPAS (Rp)</th>
...
<script>
    jQuery(document).ready(function() {
        ...
        if (type && type === 'pergeseran') {
            extend_action += '<a class="btn btn-primary ml-2" target="_blank" href="' + removeTypeParam(new_url) + '"><span class="dashicons dashicons-controls-back"></span> Halaman APBD Perda Lampiran VIII</a>';
        } else {
            extend_action += '<a class="btn btn-primary ml-2" target="_blank" href="' + new_url + '&type=pergeseran"><span class="dashicons dashicons-controls-forward"></span> Halaman Pergeseran/Perubahan APBD Perda Lampiran VIII</a>';
        }
