...
CREATE TABLE `data_capaian_prog_sub_keg` (
  ...
  `indikator_lokal` TINYINT(4) DEFAULT 0 COMMENT '0=Diambil dari sipd, 1=Diambil dari lokal',
  `active` TINYINT(4) DEFAULT '1',
  `update_at` DATETIME NOT NULL,
  `tahun_anggaran` YEAR(4) NOT NULL,
  PRIMARY KEY (id),
...
CREATE TABLE `data_output_giat_sub_keg` (
  ...
  `idsubbl` INT(11) DEFAULT NULL,
  `bobot_kinerja` VARCHAR(50) DEFAULT 1,
  `indikator_lokal` TINYINT(4) DEFAULT 0 COMMENT '0=Diambil dari sipd, 1=Diambil dari loka',
  `active` TINYINT(4) DEFAULT '1',
  `update_at` DATETIME NOT NULL,
  `tahun_anggaran` YEAR(4) NOT NULL,
  PRIMARY KEY (id),
...
CREATE TABLE `data_renstra_tujuan` (
  ...
  `kode_bidang_urusan_multiple` TEXT DEFAULT NULL,
  `kode_sasaran_multiple` TEXT DEFAULT NULL,
  PRIMARY KEY (id),
  KEY `tahun_anggaran` (`tahun_anggaran`),
  KEY `id_unik` (`id_unik`),
  KEY `id_unik_indikator` (`id_unik_indikator`),
...
CREATE TABLE `data_realisasi_renja` (
  ...
  `pendorong_bulan_1` TEXT DEFAULT NULL,
  `pendorong_bulan_2` TEXT DEFAULT NULL,
  `pendorong_bulan_3` TEXT DEFAULT NULL,
  `pendorong_bulan_4` TEXT DEFAULT NULL,
  `pendorong_bulan_5` TEXT DEFAULT NULL,
  `pendorong_bulan_6` TEXT DEFAULT NULL,
  `pendorong_bulan_7` TEXT DEFAULT NULL,
  `pendorong_bulan_8` TEXT DEFAULT NULL,
  `pendorong_bulan_9` TEXT DEFAULT NULL,
  `pendorong_bulan_10` TEXT DEFAULT NULL,
  `pendorong_bulan_11` TEXT DEFAULT NULL,
  `pendorong_bulan_12` TEXT DEFAULT NULL,
  `user` TEXT DEFAULT NULL,
  `active` TINYINT(4) NOT NULL,
  `update_at` DATETIME NOT NULL,
  `tahun_anggaran` YEAR(4) NOT NULL,
...
CREATE TABLE `data_ssh_usulan` (
  ...
  `id_standar_harga` INT(11) DEFAULT NULL,
  `kode_standar_harga` VARCHAR(30) DEFAULT NULL,
  `nama_standar_harga` VARCHAR(600),
  `satuan` TEXT,
  `spek` VARCHAR(600),
  `ket_teks` TEXT,
...
CREATE TABLE `data_renstra_program_lokal` (
  ...
  `urut_sasaran` TINYINT(4) DEFAULT NULL,
  `urut_tujuan` TINYINT(4) DEFAULT NULL,
  `id_sub_unit_usulan` INT(11) DEFAULT NULL,
  `id_sub_unit` INT(11) DEFAULT NULL,
  `active` TINYINT(4) NOT NULL,
  `update_at` DATETIME NOT NULL,
  `tahun_anggaran` YEAR(4) NOT NULL,
...
CREATE TABLE `data_program_kegiatan_manrisk_sebelum` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `id_program_kegiatan` VARCHAR(512) DEFAULT NULL,
  `id_indikator` VARCHAR(512) DEFAULT NULL,
  ...
  `uraian_resiko` TEXT DEFAULT NULL,
  `kode_resiko` TEXT DEFAULT NULL,
  `pemilik_resiko` TEXT DEFAULT NULL COMMENT '1=Kepala Daerah, 2=Kepala OPD, 3=Kepala Bidang',
  `uraian_sebab` TEXT DEFAULT NULL,
  `sumber_sebab` TEXT DEFAULT NULL COMMENT '1=Internal, 2=Eksternal, 3=Internal & Eksternal',
  `controllable` TINYINT(4) DEFAULT 1 COMMENT '0=Controllable, 1=Uncontrollable',
  `tipe` TINYINT(4) DEFAULT 1 COMMENT '0=Program, 1=Kegiatan, 2=Sub Kegiatan',
  `uraian_dampak` TEXT DEFAULT NULL,
  `pihak_terkena` TEXT DEFAULT NULL COMMENT '1=Pemerintah, 2=Perangkat Daerah, 3=Kepala OPD, 4=Pegawai OPD, 5=Masyarakat',
  `skala_dampak` VARCHAR(255) DEFAULT 0,
  `skala_kemungkinan` VARCHAR(255) DEFAULT 0,
  `nilai_resiko` VARCHAR(255) DEFAULT NULL,
  `rencana_tindak_pengendalian` TEXT DEFAULT NULL,
...
CREATE TABLE `data_pokin_renstra` (
  ...
  `id_unik` VARCHAR(255) DEFAULT NULL COMMENT 'jika tipe 6, menyimpan id_transformasi_cascading',
  `tipe` TINYINT(4) DEFAULT NULL COMMENT '1=tujuan, 2=sasaran, 3=program, 4=kegiatan, 5=sub kegiatan, 6=transformasi cascading apbd',
  `id_skpd` INT(11) DEFAULT NULL COMMENT 'jika tipe 6, wajib null biar tidak terselect by id_skpd',
  `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP,
  `tahun_anggaran` YEAR(4) DEFAULT NULL COMMENT 'jika tipe 6, wajib null biar tidak terselect by tahun_anggaran',
  `active` TINYINT(4) NOT NULL,
  PRIMARY KEY (id),
  KEY `tahun_anggaran` (`tahun_anggaran`),
  KEY `id_skpd` (`id_skpd`),
...
CREATE TABLE `data_transformasi_cascading` (
  ...
  `id_skpd` INT(11) NOT NULL,
  `id_jadwal` INT(11) NOT NULL,
  `tahun_apbd` YEAR(4) DEFAULT NULL COMMENT 'jika berisi tahun_anggaran maka itu apbd',
  `sasaran_renstra` VARCHAR(128) DEFAULT NULL COMMENT 'jika berisi id_unik sasaran maka itu apbd',
...
CREATE TABLE `data_progkeg_transformasi_cascading` (
  ...
  `id_unik` VARCHAR(50) NOT NULL COMMENT 'jika apbd maka berisi kode_sbl',
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `active` TINYINT(4) NOT NULL DEFAULT 1,
  PRIMARY KEY (id),
