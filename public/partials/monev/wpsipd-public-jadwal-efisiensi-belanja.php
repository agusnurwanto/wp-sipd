...
<div class="cetak">
    <div style="padding: 10px;margin:0 0 3rem 0;">
        ...
        <h1 class="text-center" style="margin:3rem;">Jadwal Efisiensi Belanja<br>Tahun Anggaran <?php echo $input['tahun_anggaran']; ?></h1>
...
<script>
    jQuery(document).ready(function() {
        ...
        globalThis.tipePerencanaan = 'efisiensi_belanja';
    ...
    function lock_data_penjadwalan(id_jadwal_lokal) {
        ...
        if (confirmLocked) {
            ...
            jQuery.ajax({
                ...
                type: 'post',
                data: {
                    'action': 'submit_lock_schedule_efisiensi_belanja',
                    'api_key': jQuery("#api_key").val(),
                    'id_jadwal_lokal': id_jadwal_lokal,
                    'tahun_anggaran': tahun_anggaran
                },
