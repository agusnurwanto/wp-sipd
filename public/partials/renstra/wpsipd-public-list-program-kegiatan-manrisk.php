...
foreach ($data_unit as $id_sub_skpd => $unit) {
    ...
    <tr>
        ...
        <td style='text-transform: uppercase;'><a style='margin-left: " . $margin_left . "px;' target='_blank' href='" . $final_url . "'>" . $unit['kode_skpd'] . " " . $unit['nama_skpd'] . "</a><small class='text-muted font-weight-bold'> ( " . $unit['nipkepala'] . " " . $unit['namakepala'] .  ")</small></td>
        " . $count_usulan . "
        " . $count_penetapan . "
    </tr>";
}
...
<div class="container-md">
    <div class="cetak">
        <div style="padding: 10px;margin:0 0 3rem 0;">
            ...
            <h1 class="text-center table-title">Manajemen Risiko Program Tahun <?php echo $input['tahun_anggaran']; ?></h1>
