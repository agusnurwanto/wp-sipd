...
<h1 class="text-center">Laporan Realisasi Keuangan Desa<br>per Jenis Keuangan<br>Tahun <?php echo $input['tahun_anggaran']; ?></h1>
<div class="cetak container-fluid">
    <table class="table table-bordered">
        <thead>
            <tr>
                <th class="atas kanan bawah kiri text_tengah text_blok" style="width: 30px;">No</th>
                <th class="atas kanan bawah text_tengah text_blok" >Nama Desa</th>
        ...
        <tbody>
            <tr>
                ...
                <td class="text-left"><?php echo $desa['nama'] ?></td>
