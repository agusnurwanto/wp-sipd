...
CREATE TABLE `data_akun` (
  ...
  `mulai_tahun` tinyint(4) DEFAULT NULL,
...
CREATE TABLE `data_prog_keg` (
  ...
  `bali` int(11) NOT NULL,
  `papua` int(11) NOT NULL,
  `papua_barat` int(11) NOT NULL,
  `yogyakarta` int(11) NOT NULL,
  `jakarta` int(11) NOT NULL,
  `id_daerah` int(11) NOT NULL,
  `id_daerah_khusus` int(11) NOT NULL,
  `is_setda` int(11) NOT NULL,
  `is_setwan` int(11) NOT NULL,
  `kunci_tahun` int(11) NOT NULL,
