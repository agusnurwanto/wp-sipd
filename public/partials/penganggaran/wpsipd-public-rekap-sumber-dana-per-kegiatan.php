...
$nama_excel = 'REKAPITULASI SUMBER DANA PER KEGIATAN<br>TAHUN ANGGARAN '.$input['tahun_anggaran'].'<br>'.strtoupper($nama_pemda).$nama_skpd.'<br>'.$jadwal_lokal->nama_jadwal;
