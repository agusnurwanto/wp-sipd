...
<h1 class="text-center">Bantuan BKU Dana Desa ( DD )<br>Rekapitulasi Per Kecamatan<br>Tahun <?php echo $input['tahun_anggaran']; ?></h1>
<div class="cetak">
    <div style="padding: 5px;">
        ...
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center">Tabel Bantuan BKU Dana Desa ( DD )<br>Rekapitulasi Per Kecamatan<br>Tahun <?php echo $input['tahun_anggaran']; ?></h2>
...
function per_jenis_keuangan(url_kec){
    var jenis_keuangan = '';
    var url = cek_get(url_kec)+'&jenis_keuangan=6';
