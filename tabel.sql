...
CREATE TABLE `data_lpj_sipd`(
  `id` bigint not null auto_increment,
  `id_lpj` int,
  `nomor_lpj` text DEFAULT NULL, 
  `id_daerah` int,
  `id_unit` int,
  `id_skpd` int,
  `id_sub_skpd` int,
  ...
  `jenis_lpj` text DEFAULT NULL, 
  `id_pegawai_pa_kpa` int DEFAULT NULL, 
  `is_verifikasi_lpj` bit(1) DEFAULT NULL, 
  `verifikasi_lpj_at` date DEFAULT NULL,
  `verifikasi_lpj_by` int DEFAULT 0,  
  `is_val_i_dasi_lpj` bit(1) DEFAULT NULL,   
  `val_i_dasi_lpj_at` date DEFAULT NULL,
  `val_i_dasi_lpj_by` int DEFAULT 0,  
