...
<div class="cetak">
	<div style="padding: 10px;margin:0 0 3rem 0;">
		...
		<div style="margin-bottom: 25px;" class="text-center">
			<h4 class="btn btn-warning">Total Pendapatan: Rp <span id="total_pendapatan">000.000.000</span></h4>
			<br>
	...
	function get_data_pendapatan(){
		...
		window.pendapatanTable = jQuery('#data_pendapatan_table').DataTable({
			...
			drawCallback: function(settings) {
				...
				let total_pendapatan = formatRupiah(settings.json.total_pendapatan);
