    ...
    <div class="cetak" style="padding: 5px; overflow: auto; height: 80vh;">
        <div style="padding: 10px;margin:0 0 3rem 0;"> 
            ...
            <h1 class="text-center table-title" style="padding-top: 80px">
                Manajemen Risiko Tujuan / Sasaran <br><?php echo $nama_skpd; ?><br>Tahun <?php echo $input['tahun_anggaran']; ?>
            </h1>
            ...
            <div class="wrap-table">
                <table id="cetak" title="Manajemen Risiko Tujuan / Sasaran SKPD" class="table_manrisk_tujuan_sasaran table-bordered" cellpadding="2" cellspacing="0" contenteditable="false">
                    <thead style="background: #ffc491; text-align:center;">
                        ...
                        <tr>
                            ...
                            <!-- setelah evaluasi -->
                            <th rowspan="2" class="kolom-sesudah">Tujuan Strategis/ Sasaran Strategis Pemda OPD</th>
...
<script type="text/javascript">
    ...
    function tambah_tujuan_sasaran_manrisk(id_tujuan_sasaran, id_indikator, nama_tujuan_sasaran, indikator_teks, tipe, kode_bidang) {
        ...
        reset_form_tambah(id_tujuan_sasaran, id_indikator, nama_tujuan_sasaran, indikator_teks, tipe, kode_resiko);
        
        jQuery('#editTujuanSasaranModal').modal('show');
    }

    function edit_tujuan_sasaran_manrisk(id, id_tujuan_sasaran, id_indikator, tipe, kode_bidang) {
        jQuery('#wrap-loading').show();
        jQuery.ajax({
            url: '<?php echo admin_url('admin-ajax.php'); ?>',
            type: 'POST',
    ...
    function submit_tujuan_sasaran() {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                alert(response.message);
                if (response.status === 'success') {
                    jQuery('#editTujuanSasaranModal').modal('hide');
                    get_table_tujuan_sasaran();
                }
            },
            error: function(xhr) {
    ...
    function reset_form_tambah(id_tujuan_sasaran, id_indikator, nama_tujuan_sasaran, indikator_teks, tipe, kode_resiko) {
        jQuery('#id_tujuan_sasaran').val(id_tujuan_sasaran);
        jQuery('#id_indikator').val(id_indikator);
        jQuery('#tipe_sebelum').val(tipe);
