...
foreach ($data_hibah_brg_shorted['data'] as $k => $skpd) {
    ...
    foreach ($skpd['data'] as $sub_keg) {
        ...
        $body_barang .= '
            <tr>
                <td class="kanan bawah kiri text_tengah text_blok">&nbsp;</td>
                <td class="kanan bawah text_blok text_kanan" colspan="3">Jumlah Hibah Pada Sub Kegiatan</td>
                '.$murni.'
                <td class="kanan bawah text_blok text_kanan">'.number_format($sub_keg['total'],2,",",".").'</td>
                '.$selisih.'
            </tr>
    ...
    $body_barang .= '
        <tr>
            <td class="kanan bawah kiri text_tengah text_blok">&nbsp;</td>
            <td class="kanan bawah text_blok text_kanan" colspan="3">Jumlah Hibah Pada SKPD</td>
            '.$murni.'
            <td class="kanan bawah text_blok text_kanan">'.number_format($skpd['total'],2,",",".").'</td>
            '.$selisih.'
        </tr>
...
?>
<div id="cetak" title="Laporan APBD PENJABARAN Lampiran 4a Tahun Anggaran <?php echo $input['tahun_anggaran']; ?>" style="padding: 5px;">
    <table align="right" class="no-border no-padding" cellspacing="0" cellpadding="0" style="width:280px; font-size: 12px;">
        <tr>
            <td width="80" valign="top">Lampiran IVa </td>
    ...
    <h4 style="text-align: center; font-size: 13px; margin: 10px auto; min-width: 450px; max-width: 570px; font-weight: bold;">DAFTAR NAMA CALON PENERIMA, ALAMAT DAN BESARAN<br>ALOKASI BANTUAN SOSIAL BERUPA UANG YANG DITERIMA SERTA SKPD PEMBERI BANTUAN SOSIAL<br>TAHUN ANGGARAN <?php echo $input['tahun_anggaran']; ?></h4>
