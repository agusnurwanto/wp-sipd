...
<body>
    <div id="cetak" title="APBD PERDA Lampiran V" style="padding: 5px; overflow: auto;">
        <table align="right" class="no-border no-padding" style="width:280px; font-size: 12px;">
            <tr>
                <td width="80" class="align-top">Lampiran V </td>
        ...
        <h3 class="text_tengah text-uppercase">
            ...
            REKAPITULASI BELANJA DAERAH UNTUK KESELARASAN DAN KETERPADUAN<br>
            URUSAN PEMERINTAHAN DAERAH DAN FUNGSI DALAM KERANGKA PENGELOLAAN KEUANGAN NEGARA<br>
...
<script>
    jQuery(document).ready(function() {
        ...
        if (type && type === 'pergeseran') {
            extend_action += '<a class="btn btn-primary ml-2" target="_blank" href="' + removeTypeParam(new_url) + '"><span class="dashicons dashicons-controls-back"></span> Halaman APBD Perda Lampiran V</a>';
        } else {
            extend_action += '<a class="btn btn-primary ml-2" target="_blank" href="' + new_url + '&type=pergeseran"><span class="dashicons dashicons-controls-forward"></span> Halaman Pergeseran/Perubahan APBD Perda Lampiran V</a>';
        }
