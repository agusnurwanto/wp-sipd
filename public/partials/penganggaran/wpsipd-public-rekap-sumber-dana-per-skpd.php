...
$nama_excel = 'REKAPITULASI SUMBER DANA PER SKPD<br>TAHUN ANGGARAN '.$input['tahun_anggaran'].'<br>'.strtoupper($nama_pemda).$nama_skpd.'<br>'.$jadwal_lokal->nama_jadwal;
...
foreach($data_skpd as $skpd){
    ...
    foreach ($subkeg as $kk => $sub) {
        ...
        if(empty($data_all[$sub['kode_sub_skpd']])){
            $data_all[$sub['kode_sub_skpd']] = array();
        }
        foreach($rincian_all as $rincian){
            if(empty($data_all[$sub['kode_sub_skpd']][$rincian['kode_dana']])){
                $data_all[$sub['kode_sub_skpd']][$rincian['kode_dana']] = array(
            ...
            $data_all[$sub['kode_sub_skpd']][$rincian['kode_dana']]['total'] += $rincian['total'];
            $data_all[$sub['kode_sub_skpd']][$rincian['kode_dana']]['data'][] = $rincian;
