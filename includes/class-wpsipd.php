...
class Wpsipd
{
	...
	private function define_public_hooks()
	{
		...
		$this->loader->add_action('wp_ajax_get_data_capaian_kinerja_publik_baru',  $plugin_public, 'get_data_capaian_kinerja_publik_baru');
		$this->loader->add_action('wp_ajax_nopriv_get_data_capaian_kinerja_publik_baru',  $plugin_public, 'get_data_capaian_kinerja_publik_baru');
		...
		$this->loader->add_action('wp_ajax_get_data_renstra_by_kode_sasaran_koneksi',  $plugin_public, 'get_data_renstra_by_kode_sasaran_koneksi');
		...
		$this->loader->add_action('wp_ajax_get_pemdes_alamat_all',  $plugin_public, 'get_pemdes_alamat_all');
		$this->loader->add_action('wp_ajax_nopriv_get_pemdes_alamat_all',  $plugin_public, 'get_pemdes_alamat_all');
		...
		$this->loader->add_action('wp_ajax_nopriv_get_api_renja',  $plugin_public, 'get_api_renja');
		...
		$this->loader->add_action('wp_ajax_simpan_sasaran_mcp',  $plugin_public, 'simpan_sasaran_mcp');
		...
		$this->loader->add_action('wp_ajax_edit_program_kegiatan_manrisk',  $plugin_public, 'edit_program_kegiatan_manrisk');
		$this->loader->add_action('wp_ajax_hapus_program_kegiatan_manrisk',  $plugin_public, 'hapus_program_kegiatan_manrisk');
		...
		$this->loader->add_action('wp_ajax_edit_tujuan_sasaran_manrisk_pemda',  $plugin_public, 'edit_tujuan_sasaran_manrisk_pemda');
		$this->loader->add_action('wp_ajax_verif_tujuan_sasaran_manrisk_pemda',  $plugin_public, 'verif_tujuan_sasaran_manrisk_pemda');
		$this->loader->add_action('wp_ajax_submit_verif_tujuan_sasaran_pemda',  $plugin_public, 'submit_verif_tujuan_sasaran_pemda');
		$this->loader->add_action('wp_ajax_hapus_tujuan_sasaran_manrisk_pemda',  $plugin_public, 'hapus_tujuan_sasaran_manrisk_pemda');
		
		$this->loader->add_action('wp_ajax_get_data_iku',  $plugin_public, 'get_data_iku');
		...
		add_shortcode('apbd_perda_lampiran_1', array($plugin_public, 'apbd_perda_lampiran_1'));
		add_shortcode('apbd_perda_lampiran_2', array($plugin_public, 'apbd_perda_lampiran_2'));
		...
		add_shortcode('detail_tujuan_sasaran_manrisk_pemda',array($plugin_public,'detail_tujuan_sasaran_manrisk_pemda'));
