...
<div class="modal fade mt-4" id="modalTambahDataBHRD" tabindex="-1" role="dialog" aria-labelledby="modalTambahDataBHRDLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahDataBHRDLabel">Data BHRD</h5>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary submitBtn" onclick="submitTambahDataFormBHRD()">Simpan</button>
...
<script>
    ...
    function get_data_bhrd() {
        if (typeof databhrd == 'undefined') {
            window.databhrd = jQuery('#management_data_table').on('preXhr.dt', function(e, settings, data) {
                ...
                if (res.status == 'success') {
                    ...
                    .then(function() {
                        ...
                        jQuery('#desa').val(res.data.desa).trigger('change').prop('disabled', false);
                            ...
                            jQuery('#modalTambahDataBHRD .send_data').show();
                            jQuery('#modalTambahDataBHRD').modal('show');
                    });
                } else {
                    alert(res.message);
                }
    ...
    function submitTambahDataFormBHRD() {
        ...
        jQuery.ajax({
            ...
            success: function(res) {
                alert(res.message);
                if (res.status == 'success') {
                    jQuery('#modalTambahDataBHRD').modal('hide');
                    get_data_bhrd();
                } else {
                    jQuery('#wrap-loading').hide();
                }
