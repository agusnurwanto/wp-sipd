...
class Wpsipd
{
	...
	private function define_public_hooks()
	{
		...
		$this->loader->add_action('wp_ajax_update_sasaran_rpjm',  $plugin_public, 'update_sasaran_rpjm'); // ok
		$this->loader->add_action('wp_ajax_delete_sasaran_rpjm',  $plugin_public, 'delete_sasaran_rpjm'); //

		$this->loader->add_action('wp_ajax_kelola_indikator_sasaran_rpjm',  $plugin_public, 'kelola_indikator_sasaran_rpjm'); // ok
		$this->loader->add_action('wp_ajax_submit_indikator_sasaran_rpjm',  $plugin_public, 'submit_indikator_sasaran_rpjm'); // ok
		$this->loader->add_action('wp_ajax_edit_indikator_sasaran_rpjm',  $plugin_public, 'edit_indikator_sasaran_rpjm'); // ok
		$this->loader->add_action('wp_ajax_update_indikator_sasaran_rpjm',  $plugin_public, 'update_indikator_sasaran_rpjm'); // ok
