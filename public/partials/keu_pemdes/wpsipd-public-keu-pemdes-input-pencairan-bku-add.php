...
<div class="cetak">
    ...
    <h1 class="text-center" style="margin:3rem;">Pencairan BKU Anggaran Dana Desa</h1>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahDataPencairanBKUADDLabel">Data Pencairan BKU Anggaran Dana Desa</h5>
...
function submitTambahDataFormPencairanBKUADD(){
    ...
    jQuery.ajax({
        ...
        dataType: 'json',
        data:{
            'action': 'tambah_data_pencairan_bku_add',
            'api_key': '<?php echo get_option( '_crb_api_key_extension' ); ?>',
            'id_data': id_data,
