	...
	public function get_datatable_data_sp2d_sipd()
	{
		...
		if (!empty($_POST)) {
			if (!empty($_POST['api_key']) && $_POST['api_key'] == get_option('_crb_api_key_extension')) {
				...
				$sql = "SELECT " . implode(', ', $columns) . " FROM `data_sp2d_sipd`";
				$where_first = " WHERE 1=1";
				...
				$detail_results = $wpdb->get_results(
					$wpdb->prepare('
						...
						WHERE idSpd=%s
						  ...
						  AND nomorSpd=%s
						  AND active=1
						', $idSpd, $tahun_anggaran, $nomorSpd
					), ARRAY_A
				);
				$ret['data'] = $detail_results;
				if(empty($detail_results)){
					$ret['status'] = 'error';
					$ret['message'] = 'Data dengan Nomor SPD '.$nomorSpd.' Kosong / Tidak Lengkap!';
				}
				$ret['sql'] = $wpdb->last_query;
			} else {
				$ret['status']  = 'error';
		...
		if (!empty($_POST)) {
			if (!empty($_POST['api_key']) && $_POST['api_key'] == get_option('_crb_api_key_extension')) {
				...
				$columns = array(
					...
					13 => 'idSkpd',	
					14 => 'idSubUnit',	
					15 => 'nilaiDisetujuiSpp',	
					16 => 'tanggalDisetujuiSpp',	
					17 => 'jenisSpp',	
					18 => 'verifikasiSpp',	
					19 => 'keteranganVerifikasi',	
					20 => 'idSpd',	
					21 => 'idPengesahanSpj',	
					22 => 'kunciRekening',	
					23 => 'alamatPenerimaSpp',	
					24 => 'bankPenerimaSpp',	
					25 => 'nomorRekeningPenerimaSpp',	
					26 => 'npwpPenerimaSpp',	
					27 => 'jenisLs',	
					28 => 'isUploaded',	
					29 => 'tahunSpp',	
					...
					35 => 'isGaji',	
					36 => 'is_sptjm',	
					37 => 'tanggal_otorisasi',	
					38 => 'is_otorisasi',	
					39 => 'bulan_gaji',	
					40 => 'id_pegawai_pptk',	
					41 => 'nama_pegawai_pptk',	
					42 => 'nip_pegawai_pptk',	
					43 => 'kode_tahap',	
					44 => 'is_tpp',	
					45 => 'bulan_tpp',	
					46 => 'id_pengajuan_tu',	
					47 => 'nomor_pengajuan_tu',		
					48 => 'tanggalSpm',	
					49 => 'keteranganSpm',
					50 => 'verifikasiSpm',	
					51 => 'tanggalVerifikasiSpm',
					52 => 'jenisSpm',	
					53 => 'nilaiSpm',	
					54 => 'keteranganVerifikasiSpm',	
					55 => 'isOtorisasi',	
					56 => 'tanggalOtorisasi',	
					57 => 'id'
				...
				foreach ($queryRecords as $recKey => $recVal) {
					...
					$queryRecords[$recKey]['nilaiSpm'] = number_format($recVal['nilaiSpm'], 0, ",", ".");
				}
