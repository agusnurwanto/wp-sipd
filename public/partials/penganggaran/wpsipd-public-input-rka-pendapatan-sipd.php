...
$judul = '
	...
	<td class="kiri atas kanan bawah text_blok text_tengah" style="vertical-align: middle;" rowspan="2">Formulir<br/>RKA - PENDAPATAN SKPD</td>
';
if ($type == 'rka_perubahan') {
	...
	$judul = '
		...
		<td class="kiri atas kanan bawah text_blok text_tengah" style="vertical-align: middle;" rowspan="2">Formulir<br/>RKPA - PENDAPATAN SKPD</td>
	';
	...
	$judul = '
		...
		<td class="kiri atas kanan bawah text_blok text_tengah" style="vertical-align: middle;" rowspan="2">Formulir<br/>DPA-PENDAPATAN SKPD</td>
	';
	...
	$judul = '
		...
		<td class="kiri atas kanan bawah text_blok text_tengah" style="vertical-align: middle;" rowspan="2">Formulir<br/>DPPA-PENDAPATAN SKPD</td>
	';
}
	...
	<table width="100%" class="cellpadding_5 no_break" style="border-spacing: 2px;">
		<tbody>
			...
			if (
				...
				$_POST['kode_skpd'] = $unit['kode_skpd'];
