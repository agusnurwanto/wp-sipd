...
<div class="cetak">
	<div style="padding: 10px;margin:0 0 3rem 0;">
		...
		<div style="margin-bottom: 25px;" class="text-center">
			<h4 class="btn btn-warning">Total Pembiayaan Penerimaan: Rp <span id="total_penerimaan">000.000.000</span></h4>
			<br>
			<button class="btn btn-primary tambah_penerimaan" onclick="tambah_penerimaan();"><i class="dashicons dashicons-plus" style="margin: 3px;"></i> Tambah Data</button>
		</div>
	...
	function get_data_penerimaan(){
		...
		window.penerimaanTable = jQuery('#data_penerimaan_table').DataTable({
			...
			drawCallback: function(settings) {
				...
				let total_penerimaan = formatRupiah(settings.json.total_penerimaan);
